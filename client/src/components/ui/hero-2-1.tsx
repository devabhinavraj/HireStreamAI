...
const Hero2 = () => {
  ...
  const heroImage = PlaceHolderImages.find(img => img.id === "hero-email-tool")?.imageUrl || "https://picsum.photos/seed/email/1200/800";
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10">
          ...
          {mobileMenuOpen && (
            ...
            >
              ...
              <div className="mt-8 flex flex-col space-y-6">
                ...
                <div className="pt-4">
                  <button className="w-full text-left py-2 border-b border-gray-700 text-white hover:text-gray-300">
                    Log in
                  </button>
                </div>
                <button className="h-12 rounded-full bg-white px-8 text-base font-medium text-black hover:bg-white/90 transition-colors">
        ...
        {/* Badge */}
        <div className="mx-auto mt-6 flex max-w-fit items-center justify-center space-x-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-sm border border-white/5">
        ...
        <div className="container mx-auto mt-12 px-4 text-center">
          <h1 className="mx-auto max-w-4xl text-5xl font-bold leading-tight text-white md:text-6xl lg:text-7xl font-headline tracking-tight">
          ...
          <div className="mt-10 flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
            <button className="h-12 rounded-full bg-white px-8 text-base font-medium text-black hover:bg-white/90 transition-all">
              Start Your 7 Day Free Trial
            </button>
            <button className="h-12 rounded-full border border-gray-600 px-8 text-base font-medium text-white hover:bg-white/10 transition-all">
              Watch Demo
            </button>
          </div>

          <div className="relative mx-auto my-20 w-full max-w-6xl">
            <div className="absolute inset-0 rounded shadow-lg bg-white blur-[10rem] opacity-20 pointer-events-none" />
