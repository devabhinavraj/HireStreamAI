    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-background relative overflow-hidden p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold font-headline mb-2">Reset password</h1>
            ...
            {!isSent ? (
              ...
              <div className="text-center py-4">
                <div className="w-16 h-16 bg-brand-cyan/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Mail className="text-brand-cyan w-8 h-8" />
                </div>
                <h3 className="text-xl font-bold mb-2">Check your email</h3>
                <p className="text-muted-foreground mb-6">We've sent a password reset link to {email}.</p>
                <Button variant="outline" className="rounded-xl" onClick={() => setIsSent(false)}>
